...
fn main() {
    ...
    println!("1. Context creation: {:.3}ms avg",
    ...
    println!("2. Fresh context each time: {:.3}ms avg",
    ...
    println!("3. Reused context (first 1000): {:.3}ms avg",
    ...
    println!("4. Reused context (after 1000 warmup): {:.3}ms avg ({:.1} MB/s)",
    ...
    println!("5. Reference zstd: {:.3}ms avg ({:.1} MB/s)",
    ...
    println!("Our output: {} bytes (ratio: {:.2}x)", our_result.len(),
             data.len() as f64 / our_result.len() as f64);
    println!("Ref output: {} bytes (ratio: {:.2}x)", ref_result.len(),
    ...
    println!("7. Hash table alloc (256KB): {:.3}ms avg",
    ...
    println!("8. Chain table resize (256KB): {:.3}ms avg",

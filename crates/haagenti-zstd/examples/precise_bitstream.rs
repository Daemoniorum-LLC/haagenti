...
fn main() {
    ...
    match zstd::decode_all(&our_compressed[..]) {
        ...
        Ok(d) => println!("Reference decodes ours: WRONG DATA ({} vs {} bytes)", d.len(), input.len()),
...
fn extract_bitstream(frame: &[u8]) -> Option<Vec<u8>> {
    ...
    if seq_section.len() < 2 { return None; }
...
fn decode_and_trace(bitstream: &[u8], seq_count: usize) {
    ...
    println!("Codes: LL={}, OF={}, ML={}", ll_entry.symbol, of_entry.symbol, ml_entry.symbol);
    ...
    for i in 0..seq_count {
        ...
        println!("  Extra bits needed: LL={}, OF={}, ML={}", ll_extra_bits, of_extra_bits, ml_extra_bits);
        ...
        let offset_value = (1u32 << of_code) + of_extra as u32;
        ...
        println!("  Extra values: LL_extra={}, OF_extra={}, ML_extra={}", ll_extra, of_extra, ml_extra);
        println!("  Decoded: LL={}, offset_value={} ({}), ML={}",
...
fn get_ml_baseline(code: u8) -> u32 {
    ...
    match code {
        ...
        36 => 43, 37 => 47, 38 => 51, 39 => 59,
        40 => 67, 41 => 83, 42 => 99, 43 => 131,
        44 => 259, 45 => 515, 46 => 1027, 47 => 2051,
        48 => 4099, 49 => 8195, 50 => 16387, 51 => 32771, 52 => 65539,
        _ => 3,
    }
}

...
use haagenti_zstd::fse::{FseTable, MATCH_LENGTH_ACCURACY_LOG, MATCH_LENGTH_DEFAULT_DISTRIBUTION};
...
fn main() {
    ...
    println!(
        "Table size: {} (accuracy log: {})",
        1 << MATCH_LENGTH_ACCURACY_LOG,
        MATCH_LENGTH_ACCURACY_LOG
    );

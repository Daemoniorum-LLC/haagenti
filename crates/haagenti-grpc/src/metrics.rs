...
pub fn record_compression(original_size: u64, compressed_size: u64, duration_ns: u64) {
    ...
    histogram!("haagenti_compression_duration_seconds").record(duration_ns as f64 / 1_000_000_000.0);
...
pub fn record_decompression(compressed_size: u64, original_size: u64, duration_ns: u64) {
    counter!("haagenti_decompression_total").increment(1);
    counter!("haagenti_bytes_decompressed_total").increment(original_size);
    histogram!("haagenti_decompression_duration_seconds").record(duration_ns as f64 / 1_000_000_000.0);
}
